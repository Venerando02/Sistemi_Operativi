...
int main(void)
{
  ...
  printf("Semaforo acquisito correttamente.\n");
  ...
  printf("E' stato scritto nella memoria condivisa il valore %d.\n", (*P));
  
  printf("Elimino i semafori e la share memory.\n");
  if(SEM_DEL(SemID) == -1)
  {
