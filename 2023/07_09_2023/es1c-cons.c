...
processo produttore inserisce la stringa “Fine” nell’area di memoria condivisa. Si utilizzino i semafori per la
...
int main(void)
{
  ...
  while(Running)
  {
    ...
    else
    {
      ...
      printf("La lunghezza della stringa %s e' di %d.\n", P->stringa, P->lunghezza);
    }
